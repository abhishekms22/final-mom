...
%>
        ...
        <input type="hidden" name="id" value="<%=c.getEmp_id()%>" />
			<form class="contact100-form validate-form">
				...
				<div class="wrap-input100 validate-input">
					<input id="email" class="input100" type="text" name="email" placeholder="Eg. example@email.com" value="<%=c.getEmp_email()%>"  style="color:white !important;">
					<span class="focus-input100"></span>
				...
				<div class="wrap-input100 validate-input">
					<input id="dept_id" class="input100" type="integer" name="deptid" placeholder="Department ID" value="<%=c.getDept_id()%>"  style="color:white !important;">
					<span class="focus-input100"></span>
				...
				<div class="container-contact100-form-btn">
					<button class="btn purple-gradient">
						UPDATE
					</button>
				</div>
			</form>
